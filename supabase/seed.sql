...
INSERT INTO public.terminals (id, name, address, city, lat, lng) VALUES
  ...
  ('aaaa0000-0000-0000-0000-000000000006', 'Mexico Terminal',    'Mexico Square',         'Addis Ababa',  9.0053, 38.7638),
  ('aaaa0000-0000-0000-0000-000000000007', 'Stadium Terminal',   'Addis Ababa Stadium',   'Addis Ababa',  9.0186, 38.7614);

-- ─────────────────────────────────────────────────────────────────────────────
-- SECTION 5: routes (3 routes)
-- ─────────────────────────────────────────────────────────────────────────────

INSERT INTO public.routes (id, name, start_terminal_id, end_terminal_id, intermediate_stops) VALUES
  ('bbbb0000-0000-0000-0000-000000000001', 'Merkato — Megenagna', 'aaaa0000-0000-0000-0000-000000000001', 'aaaa0000-0000-0000-0000-000000000003', ARRAY['aaaa0000-0000-0000-0000-000000000002']::uuid[]),
  ('bbbb0000-0000-0000-0000-000000000002', 'Piassa — Kaliti',     'aaaa0000-0000-0000-0000-000000000002', 'aaaa0000-0000-0000-0000-000000000004', ARRAY['aaaa0000-0000-0000-0000-000000000005']::uuid[]),
  ...
  ('bbbb0000-0000-0000-0000-000000000004', 'Merkato - Piassa',    'aaaa0000-0000-0000-0000-000000000001', 'aaaa0000-0000-0000-0000-000000000002', '{}'),
  ('bbbb0000-0000-0000-0000-000000000005', 'Piassa - Megenagna',  'aaaa0000-0000-0000-0000-000000000002', 'aaaa0000-0000-0000-0000-000000000003', '{}'),
  ('bbbb0000-0000-0000-0000-000000000006', 'Mexico — Megenagna',  'aaaa0000-0000-0000-0000-000000000006', 'aaaa0000-0000-0000-0000-000000000003', ARRAY['aaaa0000-0000-0000-0000-000000000007']::uuid[]);
...
INSERT INTO public.fares (route_id, amount, currency) VALUES
  ('bbbb0000-0000-0000-0000-000000000001', 2.50, 'ETB'),
  ('bbbb0000-0000-0000-0000-000000000002', 3.00, 'ETB'),
  ('bbbb0000-0000-0000-0000-000000000003', 2.00, 'ETB'),
  ('bbbb0000-0000-0000-0000-000000000004', 1.00, 'ETB'),
  ('bbbb0000-0000-0000-0000-000000000005', 1.50, 'ETB'),
  ('bbbb0000-0000-0000-0000-000000000006', 2.25, 'ETB');
...
INSERT INTO public.distances (from_terminal_id, to_terminal_id, distance_km, duration_minutes) VALUES
  ...
  -- Mexico ↔ Megenagna (full route)
  ('aaaa0000-0000-0000-0000-000000000006', 'aaaa0000-0000-0000-0000-000000000003',  8.2, 26),
  ('aaaa0000-0000-0000-0000-000000000003', 'aaaa0000-0000-0000-0000-000000000006',  8.2, 26),
  -- Mexico ↔ Stadium (first leg)
  ('aaaa0000-0000-0000-0000-000000000006', 'aaaa0000-0000-0000-0000-000000000007',  3.5, 12),
  ('aaaa0000-0000-0000-0000-000000000007', 'aaaa0000-0000-0000-0000-000000000006',  3.5, 12),
  -- Stadium ↔ Megenagna (second leg)
  ('aaaa0000-0000-0000-0000-000000000007', 'aaaa0000-0000-0000-0000-000000000003',  5.2, 18),
  ('aaaa0000-0000-0000-0000-000000000003', 'aaaa0000-0000-0000-0000-000000000007',  5.2, 18);
